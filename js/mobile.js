(function(root, factory) {
	...
	Mobile.prototype.renderDOM = function(){
		...
		var menuStr = $menu?'<span class="viewer-title">菜单</span><div class="viewer-div menu clearfix" id="js-mobile-menu"></div>':"";
		var tagStr = $tag?'<span class="viewer-title">标签</span><div class="viewer-div tagcloud clearfix" id="js-mobile-tagcloud"></div>':"";
		...
		<div class="viewer-box-l">\
			<div class="viewer-box-wrap">'+menuStr+tagStr+friendsStr+aboutmeStr+'</div>\
		</div>\
